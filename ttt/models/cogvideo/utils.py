...
# def get_interleave_offsets(num_frames, text_length, num_chunks, tokens_per_frame):
...
#     base_offset = base_offset * tokens_per_frame + text_length
#     init_offset = init_offset * tokens_per_frame + text_length
...
class SequenceMetadata:
    ...
    def init_multiscene_offsets(self):
        self.base_offset, self.init_offset = None, None
        # self.base_offset, self.init_offset = get_interleave_offsets(
        #     self.num_frames, self.text_length, self.num_chunks, self.tokens_per_frame
        # )
